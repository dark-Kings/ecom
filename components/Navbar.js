    ...
    <div className={`flex flex-col justify-center items-center md:flex-row md:justify-start  shadow-md sticky top-0 bg-white z-10 `}>
      ...
      <div className="nav">
        <ul className='flex items-center space-x-6 font-bold md:text-md justify-center'>
          <Link legacyBehavior href={'/AllProducts'}><a><li className='my-2 ml-2 hover:text-pink-600'>All Products</li></a></Link>
      ...
      <form>   
        ...
        <button type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-pink-500 hover:bg-black focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
        </div>
      </form>
