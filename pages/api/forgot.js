...
const handler = async (req, res) => {
    ...
    if (req.body.sendMail) {
        ...
        if (tempUser) {
            ...
            try {
                ...
                res.status(200).json({ success: false, message: 'Your password recovery mail already generated check your mail ' })
            }
    ...
    We recommend that you keep your password secure and not share it with anyone.If you feel your password has been compromised, you can change it by going to your  My Account Page and change your Password `
            ...
            res.status(200).json({ success: false, message: "user didn't exists singup" })
        }
    }
    else {
        // Reset User Password
