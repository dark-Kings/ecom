    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="lg:w-4/5 mx-auto flex flex-wrap">
        <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
          ...
          <p className="leading-relaxed mb-4">Yayy! Your order had been successfully </p><p>ordered Your payment status is <span className='font-semibold text-slate-500'>{order.status}</span></p>
       ...
       {    Object.keys(products).map((key,index)=>{
        ...
        <span className="m-auto text-center text-gray-900">{products[key].qty}</span>
        <span className="m-auto text-center text-gray-900">₹ {products[key].qty}*{products[key].price}</span>
      </div>
