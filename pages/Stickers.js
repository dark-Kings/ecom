...
const Stickers = ({products}) => {
  return (
    <div>
        ...
        <h2 className="p-10 text-center font-semibold text-[80px] allproduct_containerh2">Stickers</h2>
      <section className="min-h-screen text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4 justify-center items-center">
            {Object.keys(products).length===0 && <p className='font-semibold'>Sorry all the Stickers are currently out of stock. New stock coming soon, Stay Tuned!</p>}
